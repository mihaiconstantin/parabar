...
#>  parallel 14.54549 14.86642 15.20604 14.98447 15.13601 24.26659   100
```

Running our `task` in parallel via the `?parallel::parSapply` function takes on
average $M = 15.21$ milliseconds, with a
standard deviation of $SD = 1.24$.
...
#> Unit: milliseconds
#>     expr      min       lq     mean   median       uq      max neval
#>  parabar 71.54213 75.88346 82.75349 79.29656 88.71258 113.6531   100
```
...
#> Unit: milliseconds
#>     expr      min       lq    mean   median       uq      max neval
#>  pbapply 135.7078 137.3769 145.586 139.7884 150.6699 180.4986   100
```
...
#> t = -44, df = 193.81, p-value < 2.2e-16
